                          ...
                          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>client1</td>
                                <td>010-2222-2222</td>
                                <td><button type="button" class="btn btn-danger btn-xs">구매자 취소</button></td>
                              ...
                              <tr>
                                ...
                                <td>client2</td>
                                <td>010-8888-8888</td>
                                <td><button type="button" class="btn btn-danger btn-xs">판매자 취소</button>
                                    <button type="button" class="btn btn-success btn-xs">상품품절</button>
                                </td>
                                <td>2016-10-10 11:22:33</td>
                              </tr>
                            </tbody>
