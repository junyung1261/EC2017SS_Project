...
public class productDao {
	...
	public int insertProduct(productVo vo, int pd_id) {
		int rst = 0;
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			...
			ps = conn.prepareStatement(sql);
			ps.setInt(1, pd_id);
			ps.setString(2,vo.getPd_name());
			
			ps.setInt(3,vo.getPd_status());
			ps.setString(4,vo.getPd_summary());
			ps.setString(5, vo.getPd_main_img());
			ps.setString(6, vo.getPd_detail_img());
			
			ps.setString(7, vo.getPd_reg_date());
			ps.setString(8, vo.getPd_modify_date());	
			
			ps.setInt(9,vo.getPd_sell_count());
			ps.setInt(10,vo.getPd_wish_count());
			ps.setInt(11,vo.getPd_review_count());
			ps.setFloat(12,vo.getPd_avg_rate());
			
			ps.setString(13, vo.getPd_keyword());
			
			ps.setInt(14,vo.getPd_price());
			ps.setInt(15, vo.getPd_sale());
			ps.setInt(16, vo.getPd_sale_type());
			ps.setInt(17, vo.getPd_sale_value());
