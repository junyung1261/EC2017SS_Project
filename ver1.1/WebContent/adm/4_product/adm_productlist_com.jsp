          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>업체별 상품관리<small><%=now+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>누적 등록 상품 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                          ...
                          <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>상품 조회수 분석 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                        ...
	                        <tr>
	                          ...
	                          <td><%=cvo.getCo_id() %></td>
	                          <td><%=cvo.getCo_name() %>&nbsp;&nbsp;<a href="adm_productlist_com_search.jsp?c=<%=cvo.getCo_id() %>"><i class="fa fa-external-link"></i></a></td>
      ...
      var lineChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            pointBorderWidth: 1,
            data: [1200, 1150, 1350, 4800, 2800, 2300, 4200]
          }, {
            label: "iOS",
            ...
            pointBorderWidth: 1,
            data: [3200, 2150, 2350, 3800, 4800, 3300, 5200]
          }]
        },
      });
