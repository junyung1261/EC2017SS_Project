...
<%@ page import="ec.date.*" %>
<%@ page import = "ec.ec_pay.*" %>
<%@ page import = "ec.member.*" %>
<%	dateDao ddao = new dateDao();
	String now = ddao.now();
	
	epDao epdao = new epDao();
	ArrayList<epVo> payList = new ArrayList<epVo>();
	payList = epdao.payList();	//회원 전체 리스트
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>캐쉬 사용 현황<small><%=now+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
			              ...
			              <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>캐쉬 사용 금액 분석 <small>(단위 : 10만 원)</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                      <%for(epVo epvo : payList){  
	                    	  memberVo mvo = mdao.selectMember(epvo.getEp_mem_id());
	                      %>
	                        <tr>
	                          ...
	                          <td><%=epvo.getEp_where() %></td>
	                          <td>￦ <%=epvo.getEp_value() %></td>
	                          <td><%=epvo.getEp_time() %></td>
	                          <td>오류검증Alg+버튼</td>
	                      <%} %>
	                        </tr>
	                      </tbody>
