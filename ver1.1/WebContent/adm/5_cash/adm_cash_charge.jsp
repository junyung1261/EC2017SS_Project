...
<%@ page import="ec.date.*" %>
<%@ page import = "ec.ec_charge.*" %>
<%@ page import = "ec.member.*" %>
<%	dateDao ddao = new dateDao();
	String now = ddao.now();
	
	ecDao ecdao = new ecDao();
	ArrayList<ecVo> chargeList = new ArrayList<ecVo>();
	chargeList = ecdao.chargeList();	//회원 전체 리스트
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>캐쉬 충전 현황<small><%=now+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                      <%for(ecVo ecvo : chargeList){  
	                    	  memberVo mvo = mdao.selectMember(ecvo.getEc_mem_id());
	                      %>
	                        <tr>
	                          ...
	                          <td><%=ecvo.getEc_how() %></td>
	                          <td>￦ <%=ecvo.getEc_value() %></td>
	                          <td><%=ecvo.getEc_time() %></td>
	                          <td>오류검증Alg+버튼</td>
	                      <%} %>
	                        </tr>
	                      </tbody>
