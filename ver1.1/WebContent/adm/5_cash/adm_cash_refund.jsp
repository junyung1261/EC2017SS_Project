...
<%@ page import="ec.date.*" %>
<%@ page import = "ec.ec_refund.*" %>
<%@ page import = "ec.member.*" %>
<%	dateDao ddao = new dateDao();
	String now = ddao.now();
	
	erDao erdao = new erDao();
	ArrayList<erVo> refundList = new ArrayList<erVo>();
	refundList = erdao.refundList();	//회원 전체 리스트
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>캐쉬 환불 현황<small><%=now+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
			              ...
			              <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>캐쉬 환불 금액 분석 <small>(단위 : 10만 원)</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                          ...
                          <div class="col-md-4 col-sm-4 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>캐쉬 환불 연령 - 성별 분석 (Android)</h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
							    <div id="sonarChart1" style="height:350px;"></div>
			                  </div>
			                </div>
			              </div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                      <%for(erVo ervo : refundList){  
	                    	  memberVo mvo = mdao.selectMember(ervo.getEr_mem_id());
	                      %>
	                        <tr>
	                          <td><input type="checkbox" class="flat" name="table_records"></td>
	                          <td><%=ervo.getEr_id() %></td>
	                          <td><%=mvo.getMem_user_id() %>&nbsp;<i class="fa fa-external-link"></i></td>
	                          <td><%if(mvo.getMem_method().equalsIgnoreCase("Android")){ %>안드로이드<%}else{ %>iOS<%} %></td>
	                          <td><%=ervo.getEr_why() %></td>
	                          <td>￦ <%=ervo.getEr_value() %></td>
	                          <td><%=ervo.getEr_state() %></td>
	                          <td><%=ervo.getEr_time() %></td>
	                          <td>오류검증Alg+버튼</td>
	                      <%} %>
	                        </tr>
	                      </tbody>
   ...
   // Line chart 2
    ...
    <script>
	  ...
	  var echartPieCollapse1 = echarts.init(document.getElementById('pieChart1'), theme);
      ...
      var echartRadar1 = echarts.init(document.getElementById('sonarChart1'), theme);
