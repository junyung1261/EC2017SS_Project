          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>주문 취소<small><%=dvo.getYear()+"-"+dvo.getMonth()+"-"+dvo.getDate()+" "+dvo.getHour()+":"+dvo.getMinute()+":"+dvo.getSecond()+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                          ...
                          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><%if(ovo.getOrd_status()==300){ %><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">구매자취소</button><%}
                                	else if(ovo.getOrd_status()==301){%><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">판매자취소</button><%}
                                	else if(ovo.getOrd_status()==302){%><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">상품품절</button><%}
                                	%>
