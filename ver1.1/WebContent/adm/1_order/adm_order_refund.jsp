...
<%	dateDao ddao = new dateDao();
	...
	if(request.getParameter("co_id")!=null){
		...
		list = odao.orderList(104, co_id);
	}else{
		list = odao.orderList(4, null);
	}
...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>환불 접수<small><%=dvo.getYear()+"-"+dvo.getMonth()+"-"+dvo.getDate()+" "+dvo.getHour()+":"+dvo.getMinute()+":"+dvo.getSecond()+" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                          ...
                          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><%if(ovo.getOrd_status()==400){ %><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">환불요청</button><%}
                                	else if(ovo.getOrd_status()==401){%><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">반품확인</button><%}
                                	else if(ovo.getOrd_status()==402){%><button type="button" class="btn btn-warning btn-xs" onClick="javascript:orderPrePopup();">환불완료</button><%}
                                	%>
	...
	function orderRefundPopup(){ 
		window.open('adm_order_refund_proc.jsp?oid=EC00000001','window팝업','width=400,height=385,menubar=no,status=no,toolbar=no,scrollbars=no,location=0');
	}
	</script>
	<!-- Popup -->
    <!-- Select2 -->
