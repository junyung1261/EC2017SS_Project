...
<%	
	...
	ArrayList<mcVo> chargeList = new ArrayList<mcVo>();
	chargeList = mcdao.chargeList();	//회원 전체 리스트
%>    
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>마일리지 충전 금액 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                      <% for(mcVo mcvo : chargeList){
	                    		memberVo mvo = mdao.selectMember(mcvo.getMc_mem_id());
	                   	  %>
	                        <tr>
	                          <td><%=mvo.getMem_id() %></td>
	                          <td><%=mvo.getMem_user_id() %></td>
	                          <td><%=mvo.getMem_method() %></td>
	                          <td>￦ <%=mcvo.getMc_how() %></td>
	                          <td>￦ <%=mcvo.getMc_value() %></td>
	                          <td><%=mcvo.getMc_time() %></td>
	                          <td>오류검증Alg+버튼</td>
	                        </tr>
	                        <%} %>
	                      </tbody>
