...
<%	
	...
	ArrayList<mtVo> mileageList = new ArrayList<mtVo>();
	mileageList = mtdao.mileageList();	//회원 전체 리스트
%>    
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>마일리지 충전 금액 분석 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
			              ...
			              <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>마일리지 사용 금액 분석 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
			              ...
			              <div class="col-md-4 col-sm-6 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>마일리지 잔고 금액 분석 <small>Sessions</small></h2>
			                    <div class="clearfix"></div>
			                  </div>
			                  <div class="x_content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <tbody>
	                      <% for(mtVo mtvo : mileageList){
	                    		memberVo mvo = mdao.selectMember(mtvo.getMt_mem_id());
	                   	  %>
	                        <tr>
	                          <td><%=mvo.getMem_id() %></td>
	                          <td><%=mvo.getMem_user_id() %></td>
	                          <td><%=mvo.getMem_method() %></td>
	                          <td>￦ <%=mtvo.getMt_value() %></td>
	                          <td><%=mtvo.getMt_time() %></td>
	                          <td>오류검증Alg+버튼</td>
	                        </tr>
	                        <%} %>
	                      </tbody>
      ...
      var lineChart2 = new Chart(ctx2, {
        ...
        data: {
          ...
          datasets: [{
            ...
            pointHoverBorderColor: "rgba(220,220,220,1)",
            pointBorderWidth: 1,
            data: [3500, 4000, 4000, 2000, 4800, 4500, 4100]
          }, {
            label: "iOS",
            backgroundColor: "rgba(3, 88, 106, 0.3)",
            borderColor: "rgba(3, 88, 106, 0.70)",
            ...
            pointHoverBorderColor: "rgba(151,187,205,1)",
            pointBorderWidth: 1,
            data: [1500, 2000, 2000, 1000, 3800, 3500, 3100]
          }]
        },
      });
