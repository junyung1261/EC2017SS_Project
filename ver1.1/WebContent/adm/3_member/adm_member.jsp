                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <%for(memberVo mvo : memberList){ 
	                    	 ...
	                    	 %>
	                        <tr>
	                          <td><input type="checkbox" class="flat" name="mem_id"></td>
	                          <td><%=mvo.getMem_id() %></td>
	                          ...
	                          <td><button type="button" class="btn btn-warning btn-xs" onClick="javascript:window.open('adm_member_detail.jsp?mem_id=<%=mvo.getMem_id() %>','window팝업','width=450,height=620,menubar=no,status=no,toolbar=no,scrollbars=1,location=0')">정보보기</button>
	                          		<button type="button" class="btn btn-warning btn-xs" onClick="javascript:window.open('adm_member_change.jsp?mem_id=<%=mvo.getMem_id() %>','window팝업','width=450,height=620,menubar=no,status=no,toolbar=no,scrollbars=1,location=0')">정보수정</button>
	                          </td>
	                        </tr>
	                       <%} %>
	                      </tbody>
