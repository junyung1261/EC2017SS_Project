...
<%	dateDao ddao = new dateDao();
	...
	String today = dvo.getMinute()+"/"+dvo.getDate()+"/"+dvo.getYear();
	String now = dvo.getMinute()+"/"+dvo.getDate()+"/"+dvo.getYear()+" "+dvo.getHour()+":"+dvo.getMinute()+":"+dvo.getSecond();
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>업체 계약관리<small><%=now +" 현재" %></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
	                      ...
	                      <%for(companyVo cvo : companyList){ %>
	                        <tr>
	                          <td><input type="checkbox" class="flat" name="co_id" value="<%=cvo.getCo_id() %>"></td>
	                          <td><%=cvo.getCo_id() %></td>
	                          <td><%=cvo.getCo_name() %></td>
	                          <td><%=cvo.getCo_grade() %></td>
	                          <td><%=cvo.getCo_reg_date() %></td>
	                          <td><%=cvo.getCo_exp_date() %></td>
	                          <td>
	                          	<button type="button" class="btn btn-info btn-xs">서비스중</button></td>    
