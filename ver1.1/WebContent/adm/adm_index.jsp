        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Sales Amount <small>&nbsp;&nbsp;
                    <i class="fa fa-android"></i> Android & <i class="fa fa-apple"></i> iOS (단위 : ￦1,000)</small></h3>
                  </div>
                  <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel tile fixed_height_320">
                <div class="x_title">
                  <h2>PPC <small>Purchase Per Click</small></h2>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Brand 1 </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>Brand 2 </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Brand 3 </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Brand 4 </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
              ...
              <div class="x_panel tile fixed_height_320">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      <li><i class="fa fa-key"></i><a href="#">Login</a></li>
                      <li><i class="fa fa-gift"></i><a href="#">Product View</a></li>
                      <li><i class="fa fa-image"></i><a href="#">Image Search</a></li>
                      <li><i class="fa fa-keyboard-o"></i><a href="#">Keyword Search</a></li>
                    </ul>
                    ...
                    <div class="sidebar-widget">
                      ...
                      <div class="goal-wrapper">
                        ...
                        <span id="goal-text" class="goal-value pull-right">Total 10</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Recent Messages <small>more..</small></h2>
                  <ul class="nav navbar-right panel_toolbox">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>To Do List <small>Mandatory Requirement</small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                      ...
                      <div class="">
                        <ul class="to_do">
                          <li><p><input type="checkbox" class="flat"> 신규 주문 확인 </p></li>
                          <li><p><input type="checkbox" class="flat"> 업체 계약 만료일자 확인</p></li>
                          <li><p><input type="checkbox" class="flat"> 업체 신규 등록 처리</p></li>
                          <li><p><input type="checkbox" class="flat"> 일일 정산 처리</p></li>
                          <li><p><input type="checkbox" class="flat"> 교환 요청 처리</p></li>
                          <li><p><input type="checkbox" class="flat"> 환불 요청 처리</p></li>
                        </ul>
                      </div>
                    </div>
                  </div>
