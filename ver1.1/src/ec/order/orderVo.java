...
public class orderVo {
	...
	public int getOr_use_mileage() {
		return or_use_mileage;
	}
	public void setOr_use_mileage(int or_use_mileage) {
		this.or_use_mileage = or_use_mileage;
	}
	...
	public int getOrd_delivery_method() {
		return ord_delivery_method;
	}
